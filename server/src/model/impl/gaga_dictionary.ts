...
export class GagaDictionary implements Dictionary {
    private readonly words =
        ...
        'образование снаряд боевик шпагат жизнь пояс билет мушка шпион коса сила пляж панель ' +
        'миллионер вагон век пистолет треугольник казино амфибия блок предложение ' +
